...
const DialogEdit = ({ getMsproductData }: DialogMsproductProps) => {
    const [master_product_id, setMaster_product_id] = useState("");
    ...
    patchMsproduct({
        master_product_name: master_product_name, master_product_id, scale_product, create_by, description, update_by, update_date, image, height: height,
        length: 0,
        width: 0,
